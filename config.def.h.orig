...
static const char col_gray2[]       = "#3B4252"; // Inactive border
static const char col_gray3[]       = "#D8DEE9"; // Font color
static const char col_gray4[]       = "#ECEFF4"; // Active font color
static const char col_cyan[]        = "#4C566A"; // Top bar active color (Darker Nord)
static const char col_border[]      = "#88C0D0"; // Active border (Icy Blue)
...
{ 0, XF86XK_AudioMute,        spawn, SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle") },
    ...
    { 0, XF86XK_AudioRaiseVolume, spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5% --cap-at-100%") },
    /* Brightness */
